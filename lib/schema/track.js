 ...
 * 1.生产:{}
 * 2.销售:{
 * companyCode: {type: String}, // 购买单位_法人和其他组织统一社会信用代码
 * companyName: {type: String}, // 购买单位名
 ...
 * }
 * 3.购买:{
 * companyCode: {type: String}, // 销售单位_法人和其他组织统一社会信用代码
 * companyName: {type: String}, // 销售单位名
 * address: {type: String}, // 地址
 ...
 * 5.处置:{}
 * 6.转让:{
 * companyCode: {type: String}, // 接收单位_法人和其他组织统一社会信用代码
 * companyName: {type: String}, // 接收单位名
 * storageCode: {type: String}, // 接收单位储存场所编码
 * storageName: {type: String}, // 接收单位储存场所名
 * }
 * 5.丢失被盗:{
